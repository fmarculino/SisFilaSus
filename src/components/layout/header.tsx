...
export function Header({
  ...
  const getRoleLabel = (role: string) => {
    switch (role) {
      case 'SMS_ADMIN': return 'Administrador Geral'
      case 'COORDENADOR': return 'Coordenador da Regulação'
      case 'MEDICO_REGULADOR': return 'Médico Regulador'
      case 'OPERADOR_REGULACAO': return 'Operador'
      case 'AUXILIAR': return 'Auxiliar Administrativo'
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden sm:flex flex-col">
          <h1 className="text-xl md:text-2xl font-black text-foreground tracking-tighter uppercase">
            Sis<span className="text-primary italic">FilaSus</span>
          </h1>
          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] opacity-50 mt-1">
