...
export function Pagination({ totalItems, itemsPerPage, currentPage, onPageChange }: PaginationProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6 px-8 bg-card/30 backdrop-blur-md border-t border-border/20 rounded-b-[2rem] no-print">
      <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
        ...
        <div className="flex items-center gap-3 bg-muted/50 p-1 px-3 rounded-xl border border-border/50">
          ...
          >
            ...
            <option value="55" className="bg-card text-foreground">50</option>
          </select>
        </div>
      </div>
